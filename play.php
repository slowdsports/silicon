            ...
            <div class="gallery mb-4 pb-2">
                ...
                <div class="embed-responsive embed-responsive-16by9 hidden" id="playerContainer">
                    ...
                    if (strpos($canalUrl, "claro")) {
                        $src = "id='embed-player' class='embed-responsive-item' width='100%' height='100%' frameborder='0' scrolling='no' allowfullscreen allow='encrypted-media' src='//clarovideo.irtvhn.info?c=$canalId'";
