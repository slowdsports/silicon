...
if ($json_content !== false) {
    ...
    file_put_contents('vix.json', $json_content);
} else {
...
<section class="container mb-5 pt-4 pb-2 py-mg-4">
    ...
    <div class="alert alert-danger text-center">Esta sección está siendo desarrollada y los eventos podrían no funcionar correctamente.</div>
    <!-- Events grid -->
