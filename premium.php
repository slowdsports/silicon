<div class="container">
    <div class="row pt-xl-2 pb-md-3">
        <div class="col-lg-5 mb-4 mb-lg-0">
            <h2 class="h1 text-center text-sm-start mb-4">Elimina los anuncios y accede a contenido exclusivo</h2>
            <p class="pb-2 pb-lg-4 pb-xl-5 mb-3">
                ¿Cansado de los anuncios?
                <br>
                Entendemos lo frustrante que puede ser lidiar con anuncios mientras navegas. Sin embargo, son nuestra principal fuente de ingresos para mantener la página funcionando.<br>
                Tú decides: puedes seguir disfrutando del contenido gratuito con anuncios o dar el siguiente paso hacia una experiencia premium sin interrupciones y acceso a canales exclusivos, apoyándonos con tu contribución económica.
            </p>
            <p class="fs-sm"><a href="https://t.me/+oi-QsjZMJqFhMTFh" target="_blank">Contáctanos</a> para validar tu aportación y activar tu cuenta ❤</p>
        </div>
                    ...
                    <div class="px-md-4 position-relative zindex-5">
                        <div class="d-sm-flex align-items-start justify-content-between">
                            <div class="text-center text-sm-start me-sm-4">
                                <div class="lead fw-semibold text-light text-uppercase mb-2">iRaffle TV</div>
                                <h3 class="h1 text-light">Credencial VIP</h3>
                            </div>
                            <div class="d-table bg-white rounded-3 p-4 flex-shrink-0 mx-auto mx-sm-0">
                                <img src="assets/img/qr.png" width="102" alt="QR Code" />
                            </div>
                        </div>
                        <div class="d-flex flex-column flex-sm-row align-items-center pt-4 mt-2">
                            <a href="https://patreon.com/slowdsports?utm_medium=unknown&utm_source=join_link&utm_campaign=creatorshare_creator&utm_content=copyLink" class="btn btn-light btn-lg mb-3 mb-sm-0 me-sm-3" target="_blank">Compra el acceso</a>
                            <div class="d-flex align-items-center">
                                <span class="fs-lg text-light me-2">Tan solo</span>
                                <span class="h4 text-light mb-0">$4.99</span>
                            </div>
                        </div>
                    </div>
                    <span class="position-absolute top-50 end-0 translate-middle-y bg-light rounded-circle p-4 me-n4"></span>
                </div>
                <span class="position-absolute bg-gradient-primary opacity-60 bottom-0 mb-n2 d-dark-mode-none" style="left: 1.5rem; width: calc(100% - 3rem); height: 5rem; filter: blur(0.625rem);"></span>
            </div>
