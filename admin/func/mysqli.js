...
function agregarPartidosAuto() {
    var elemento = document.getElementById('auto').value;
    ...
    xmlhttp.open("POST", "api/perLeague.php", true);
    xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function editarPartido() {
    ...
    xmlhttp.open("POST", "func/update.php", true);
    xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
