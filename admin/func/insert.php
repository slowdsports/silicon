...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['partido'])){
        ...
        $starp = $_POST["starp"];
        $vix = $_POST["vix"];
        $sql = "INSERT INTO `partidos`(`local`, `visitante`, `liga`, `fecha_hora`, `starp`, `vix`, `canal1`, `canal2`, `canal3`, `canal4`, `canal5`, `canal6`, `canal7`, `canal8`, `canal9`, `canal10`) VALUES ('$local','$visitante','$liga','$fecha','$starp','$vix',$canal1,$canal2,$canal3,$canal4,$canal5,$canal6,$canal7,$canal8,$canal9,$canal10);";
